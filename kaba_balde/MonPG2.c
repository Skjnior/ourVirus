/*
 * Fichier : MonPG2.c (Programme Cible 2)
 * Rôle : Algorithme de vérification mathématique (Carré Parfait).
 * Utilité dans le projet : Programme cible démontrant la persistance 
 * des calculs mathématiques (libm) après le relais du virus compagnon.
 */
#include <stdio.h>
#include <stdbool.h>
#include <math.h>
