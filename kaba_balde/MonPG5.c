/*
 * Fichier : MonPG5.c (Programme Cible 5)
 * Rôle : Interface interactive pour tracer de multiples fonctions mathématiques via Gnuplot.
 * Utilité dans le projet : Programme cible le plus complexe (forking, execution de scripts tiers).
 * Il valide définitivement que la substitution par le virus compagnon puis l'exécution 
 * via execl() ne casse pas les comportements multiprocessus d'une application légitime.
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
